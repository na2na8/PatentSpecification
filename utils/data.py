    ...
    with open(save_path, 'a', newline='') as f :
        ...
        for idx in tqdm(range(start_idx, num_data)) :
            ...
            for trunc in truncated :
                encoder_input = masking(trunc, tokenizer, max_length)
        ...
        encoder_input = masking(with_special_tokens, tokenizer, max_length)
...
if __name__ == "__main__" :
    ...
    # valid
    gen_data(512, tokenizer, '/home/ailab/Desktop/NY/2023_ipactory/data/csv/valid.csv', True, valid, 0)
    
    # train
    gen_data(512, tokenizer, '/home/ailab/Desktop/NY/2023_ipactory/data/csv/train.csv', True, train, 0)
